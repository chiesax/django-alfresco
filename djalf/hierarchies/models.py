...
from djalf.hierarchies import utils
from djalf.hierarchies.managers import CategoryManager

from djalf.alfresco.models import Space
...
class Hierarchy(models.Model):
    ...
    space = models.OneToOneField(Space, blank=True, null=True, on_delete=models.SET_NULL)
...
class Category(models.Model):
    hierarchy = models.ForeignKey('Hierarchy', blank=True, null=True, help_text="Must be explicitly selected if there is no parent category.",
                                  related_name='categories', on_delete=models.SET_NULL)
