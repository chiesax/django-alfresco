...
from djalf.alfresco.service import AlfrescoException
from djalf.alfresco.settings import  ALFRESCO_DEFAULT_USER, ALFRESCO_DEFAULT_USER_PASSWORD, ALFRESCO_AUTO_LOGIN_ATTEMPTS
from django.contrib.auth import authenticate, login as auth_login
from django import http


class AlfrescoMiddleware:
    """
