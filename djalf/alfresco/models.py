...
from djalf.alfresco.managers import AlfrescoContentManager, UserManager
from djalf.alfresco.fields import AlfrescoField
...
class Content(models.Model):
    ...
    space = models.ForeignKey(Space, related_name="contents", on_delete=models.CASCADE)
